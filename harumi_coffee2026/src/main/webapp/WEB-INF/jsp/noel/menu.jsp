...
<body>
	...
	<main>
		...
		<div class="card">
			<ul class="menu-list">
				<li><a class="btn" href="<%= ctx %>/order">注文受付</a></li>
				<li><a class="btn" href="<%= ctx %>/coffee">コーヒー管理（補充・削減）</a></li>
				<li><a class="btn" href="<%= ctx %>/closing">閉店処理</a></li>
			</ul>
		</div>

		<p class="pattern-note">
			表示パターンの切り替え：
			<a href="<%= ctx %>/login?mode=el">EL/JSTL版</a> ／
			<a href="<%= ctx %>/login?mode=noel">スクリプトレット版</a>
		</p>
	</main>
</body>
</html>

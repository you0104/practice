...
<body>
	...
	<main>
		...
		<div class="card">
			<ul class="menu-list">
				<li><a class="btn" href="${URL_ORDER_SERVLET}">注文受付</a></li>
				<li><a class="btn" href="${URL_COFFEE_SERVLET}">コーヒー管理（補充・削減）</a></li>
				<li><a class="btn" href="${URL_CLOSING_SERVLET}">閉店処理</a></li>
			</ul>
		</div>

		<p class="pattern-note">
			表示パターンの切り替え：
			<a href="${URL_LOGIN_SERVLET}?mode=el">EL/JSTL版</a> ／
			<a href="${URL_LOGIN_SERVLET}?mode=noel">スクリプトレット版</a>
		</p>
	</main>
</body>
</html>
